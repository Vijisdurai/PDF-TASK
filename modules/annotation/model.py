"""
Annotation model for document and image annotations.

Supports two annotation types:
- Document annotations: page-based with percentage coordinates
- Image annotations: pixel-based coordinates
"""
