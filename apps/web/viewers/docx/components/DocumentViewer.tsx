...
import DocxViewer from '@/viewers/docx/DocxViewer';
      ...
      case 'pdf':
        return (
          <PDFViewer
            ...
            annotations={annotations.filter((ann): ann is DocumentAnnotation =>
              ann.type === 'document'
            )}
      ...
      case 'image':
        ...
        return (
          <ImageViewer
            ...
            zoomScale={viewerState.zoomScale}
            onZoomChange={handleZoomChange}
            annotations={annotations.filter((ann): ann is ImageAnnotation =>
              ann.type === 'image'
            )}
