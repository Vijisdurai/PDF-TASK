...
// Note: This file is in /core but needs to import from apps/web
// These imports will be resolved by the frontend build system
import { DatabaseService } from '../../apps/web/api/database';
import { apiService } from '../../apps/web/api/api';
